...
const calculator = (number1, number2) => {
  ...
  // if (!number1 || !number2 || typeof number1 !== 'number' || typeof number2 !== 'number') {
  //   return undefined;
  // }
  soma = Math.floor(number1 + number2);
  multip = Math.floor(number1 * number2);
  divi = Math.floor(number1 / number2);
  subtr = Math.floor(number1 - number2);
  return {
    sum: soma,
    mult: multip,
    div: divi,
